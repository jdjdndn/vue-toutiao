<template>
  <div class="article-container">
    <!-- 导航栏 -->
    <van-nav-bar class="page-nav-bar" left-arrow title="颜色头条"> <span slot='left' @click='goback'>
...
<script>
import { getUserArticle } from '@/api/articals'
...
export default {
  ...
  methods: {
    async loadArticles () {
      this.loading = true
      try {
        const { data } = await getUserArticle(this.articleId)
